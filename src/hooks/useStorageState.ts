...
export async function clearStorage(): Promise<void> {
  if (Platform.OS === "web") {
    ...
    await SecureStore.deleteItemAsync("WALLET_UNLOCKED_AT");
    await SecureStore.deleteItemAsync("WALLET_BIOMETRIC_PREF");
    await SecureStore.deleteItemAsync("SNAP_POINTS");
  }
}
